...
```javascript
import append from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-append@v0.2.2-deno/mod.js';
```
...
[@stdlib/utils/prepend]: https://github.com/stdlib-js/utils-prepend/tree/deno
